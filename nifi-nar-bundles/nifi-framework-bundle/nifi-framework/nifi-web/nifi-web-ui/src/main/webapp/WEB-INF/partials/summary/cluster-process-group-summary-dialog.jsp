...
<div id="cluster-process-group-summary-dialog">
    <div class="dialog-content">
        <div id="cluster-process-group-summary-header">
            <fmt:message key="partials.summary.cluster-process-group-summary-dialog.Refresh" var="Refresh"/>
            ...
            <div id="cluster-process-group-summary-last-refreshed-container">
                <fmt:message key="partials.summary.cluster-process-group-summary-dialog.LastUpdated"/>&nbsp;<span id="cluster-process-group-summary-last-refreshed"></span>
            </div>
