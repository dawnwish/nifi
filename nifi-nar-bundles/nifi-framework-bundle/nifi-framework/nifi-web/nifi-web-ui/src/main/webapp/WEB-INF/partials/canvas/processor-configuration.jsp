                    ...
                    <div class="setting">
                        ...
                        <div class="setting-field">
                            ...
                            <div class="processor-enabled-container">
                                ...
                                <span><fmt:message key="partials.canvas.processor-configuration.Enabled"/></span>
                            </div>
                        </div>
                    </div>
                    <div class="setting">
                    ...
                    <div class="setting">
                        <div class="penalty-duration-setting">
                            <div class="setting-name">
                                ...
                                <img class="setting-icon icon-info" src="images/iconInfo.png" alt="Info" title="${title_PenaltyDuration}"/>
                            </div>
                            <div class="setting-field">
                    ...
                    <div class="setting">
                        <div class="bulletin-setting">
                            <div class="setting-name">
                                ...
                                <img class="setting-icon icon-info" src="images/iconInfo.png" alt="Info" title="${title_BulletinLevel}"/>
                            </div>
                            <div class="setting-field">
                ...
                <div class="settings-right">
                    <div class="setting">
                        <div class="setting-name">
                            ...
                            <img class="setting-icon icon-info" src="images/iconInfo.png" alt="Info" title="${title_AutoTerminateRelationships}"/>
                        </div>
                        <div class="setting-field">
                ...
                <div class="settings-left">
                    ...
                    <div id="timer-driven-options" class="setting">
                        ...
                        <div class="scheduling-period-setting">
                            <div class="setting-name">
                                ...
                                <fmt:message key="partials.canvas.processor-configuration.RunSchedule.title.1" var="1"/>
                                <img class="setting-icon icon-info" src="images/iconInfo.png" alt="Info" title="${1}"/>
                            </div>
                            <div class="setting-field">
                    ...
                    <div id="cron-driven-options" class="setting">
                        ...
                        <div class="scheduling-period-setting">
                            <div class="setting-name">
                                <fmt:message key="partials.canvas.processor-configuration.RunSchedule"/>
                                <fmt:message key="partials.canvas.processor-configuration.RunSchedule.title.2" var="2"/>
                                <img class="setting-icon icon-info" src="images/iconInfo.png" alt="Info" title="${2}"/>
                            </div>
                            <div class="setting-field">
