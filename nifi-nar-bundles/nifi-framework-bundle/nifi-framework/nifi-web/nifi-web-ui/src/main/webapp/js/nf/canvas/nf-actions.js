                    ...
                    var completeDropRequest = function () {
                        if (nf.Common.isDefinedAndNotNull(dropRequest)) {
                            $.ajax({
                                ...
                                $('<span></span>').text(nf._.msg('nf-actions.Message7')).appendTo(results);
                        ...
                        click: function () {
                            ...
                            nf.Snippet.create(snippetDetails).done(function (response) {
                                ...
                                $.ajax({
                                    ...
                                    nf.Dialog.showOkDialog({
                                        dialogContent: nf._.msg('nf-actions.Template') + nf.Common.escapeHtml(templateName) + nf._.msg('nf-actions.Message11'),
                                        overlayBackground: false
                                    });
                                }).always(function () {
                                    // remove the snippet
        ...
        paste: function (selection, evt) {
            ...
            nf.Clipboard.paste().done(function (data) {
                ...
                copySnippet.fail(function () {
                    ...
                    nf.Dialog.showOkDialog({
                        dialogContent: nf._.msg('nf-actions.Message12'),
                        overlayBackground: true
                    });
                });
            });
