            ...
            <div id="attributes-tab-content" class="details-tab">
                <div id="attributes-details">
                    ...
                    <div id="modified-attribute-toggle-container">
                        <div id="modified-attribute-toggle-label"><fmt:message key="partials.provenance.provenance-event-details-dialog.OnlyShowModified"/></div>
            ...
            <div id="content-tab-content" class="details-tab">
                <div class="settings-left">
                    <div id="input-content-details" class="content-details">
                        ...
                        <div class="event-detail">
                            <div id="input-content-download" class="button hidden"><fmt:message key="partials.provenance.provenance-event-details-dialog.Download"/></div>
                            <div id="input-content-view" class="button hidden"><fmt:message key="partials.provenance.provenance-event-details-dialog.View"/></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="settings-right">
                    <div id="output-content-details" class="content-details">
                        ...
                        <div class="event-detail">
                            <div id="output-content-download" class="button hidden"><fmt:message key="partials.provenance.provenance-event-details-dialog.Download"/></div>
                            <div id="output-content-view" class="button hidden"><fmt:message key="partials.provenance.provenance-event-details-dialog.View"/></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="replay-details" class="content-details hidden">
                    ...
                    <div class="event-detail">
                        <div id="replay-content" class="button"><fmt:message key="partials.provenance.provenance-event-details-dialog.Submit"/></div>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
